...
const endpoints: Record<string, Array<Endpoint>> = {
  markets: [
    {
      method: "GET",
      ...
      queryParams: [
        {
          ...
          type: "string",
          required: false,
          description: '"active" or "resolved". Defaults to "active"',
        },
        {
          name: "page",
          type: "number",
  ...
  "markets": [
    ...
    },
    {
      ...
      auth: "none",
      pathParams: [{ name: "id", type: "number", description: "The market ID" }],
      response: "Market",
      example: {
        response: `{
  "id": 1,
    ...
    },
    {
      ...
      requestBody: [
        ...
        },
        {
          ...
          type: "string[]",
          required: true,
          description: "Array of outcome titles (minimum 2)",
        },
      ],
      ...
      requestBody: [
        {
          ...
          type: "number",
          required: true,
          description: "The outcome ID to bet on",
        },
        {
          name: "amount",
          type: "number",
          required: true,
          description: "Bet amount (must be positive, deducted from balance)",
        },
      ],
        ...
        <Card className="mt-8">
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground text-sm">
              ...
              <code className="bg-muted px-1 rounded">errors</code> array:
            </p>
            <CodeBlock
              code={`{
