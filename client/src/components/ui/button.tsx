...
const buttonVariants = cva(
  "inline-flex justify-center items-center disabled:opacity-50 rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 font-mali text-sm whitespace-nowrap transition-all duration-300 cursor-pointer disabled:pointer-events-none",
  {
    variants: {
      variant: {
        default: "bg-primary text-cyan-100 text-primary-foreground hover:bg-primary/90",
        destructive: "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border text-cyan-200 border-input bg-background hover:bg-accent hover:text-accent-foreground",
        ...
        cyanSoft:
          "bg-cyan-700 text-cyan-100 shadow hover:bg-cyan-800 hover:text-white hover:shadow-none",
      },
      size: {
